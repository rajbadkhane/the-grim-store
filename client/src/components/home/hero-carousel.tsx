  ...
  return (
    <section className="relative min-h-[calc(100vh-4rem)] overflow-hidden">
      <Image
        ...
        alt="premium electronics editorial"
        fill
        sizes="100vw"
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl items-center px-4 pb-24 pt-16 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-2xl">
          <p className="text-sm font-black uppercase tracking-[0.28em] text-blue-400">Limited summer drop</p>
          ...
          <p className="mt-5 max-w-xl text-base leading-7 text-white/72 sm:text-lg">
            Premium black and red electronics built for expressive shoppers, fast discovery, verified reviews, and a checkout that does not get in the way.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/products" className="inline-flex min-h-11 items-center gap-2 rounded-md bg-blue-600 px-5 text-sm font-bold text-white shadow-[0_12px_28px_rgba(59,130,246,0.25)] hover:bg-blue-500">
