...
import { applyCoupon, checkout, createPaymentOrder, listMyOrders, listOrders, trackOrder, updateOrderStatus, verifyPayment } from "../controllers/order.controller.js";
...
orderRoutes.get("/:id/track", trackOrder);
