...
import { createManualReview, createReview, deleteReview, helpfulReview, listAllReviews, listReviews, reportReview, updateReview } from "../controllers/review.controller.js";
import { requireAdmin, requireAuth } from "../middlewares/auth.js";
import { reviewLimiter } from "../middlewares/rateLimiter.js";
import { validate } from "../middlewares/validate.js";
import { manualReviewSchema, reviewSchema } from "../validators/review.validator.js";

export const reviewRoutes = Router();

reviewRoutes.get("/product/:productId", listReviews);
reviewRoutes.get("/", requireAuth, requireAdmin, listAllReviews);
reviewRoutes.post("/manual", requireAuth, requireAdmin, validate(manualReviewSchema), createManualReview);
